        ...
        <>
            ...
            <div className="grid grid-cols-6 px-[2%] gap-5 sm:px-[5%] lg:px-[8%] pt-3">
                <div className="col-span-4">
                    ...
                    <h2 className="text-4xl font-bold py-3">{serviceData?.title}</h2>
                    <div>
                    <p className="text-2xl font-semibold"> Price : ${serviceData?.price}</p>
                    <p className="text-2xl font-semibold">Duration : {serviceData?.duration}</p>
                    </div>
                    </div>
