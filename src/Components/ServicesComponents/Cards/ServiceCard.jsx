...
const ServiceCard = ({ service }) => {
  ...
  return (
    <div className="relative rounded-[15px] mt-20 service-card shadow-gray-300 shadow-xl  ">
      ...
      <img src={serviceImg} alt="" className="w-full min-h-[380px]  rounded-[15px]" />
      ...
      <div className="w-full h-full absolute top-0 bg-[#ababab00] rounded-[15px] pt-10 px-10 service-content ">
        ...
        <div className="mt-28 service-des text-white lg:space-y-4 md:space-y-2  ">
          ...
          <button className="text-xl hidden uppercase font-semibold tracking-widest mt-4 rounded-full border-[#e5c466] border lg:px-8 lg:py-4 px-6 py-3 ">
            More Details
          </button>
          </Link>
          </div>
