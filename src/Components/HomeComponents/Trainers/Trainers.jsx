    ...
    return (
        <div className='primary-white py-28 px-[10%]'>
            ...
            <div className='text-center pt-8'>
                <Link to={'/trainers'}><button className='rounded-md px-8 py-3 hover:bg-[#144479] border border-sky-700 hover:text-sky-100 text-sky-700 font-bold capitalize md:text-2xl text-base  transition-all duration-150 ease-in-out '>All Trainer</button></Link>
            </div>
        </div>
    );
};
