        ...
        <div className='text-white border-secondary rounded-t-md trainer'>
            <div className='relative'>
                ...
                <div className='absolute bg-[#000000cc] w-full h-full top-0 hidden place-items-center'>
                    <Link className='bg-white hover:bg-[#448c7400] hover:text-white secondary-color border border-white rounded-md px-4 py-2 font-bold uppercase' to={`/trainersdetails/${trainer._id}`}>About Trainer</Link>
                </div>
            </div>
