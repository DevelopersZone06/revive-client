  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row md:flex-row px-[2%] sm:px-[5%] lg:px-[8%] mt-28 gap-10">
        ...
        />
        <div>
          <h2 className="text-2xl md:text-4xl lg:text-6xl font-bold  text-sky-800">
          ...
          <ul className="list-image">
            <li className="flex gap-4">
              <IoCheckmarkDone className="w-[25px] text-sky-700 " />
      ...
      <div className="flex flex-col sm:flex-row md:flex-row justify-between px-[2%] sm:px-[5%] lg:px-[8%] mt-28 gap-10">
        ...
        <img
          src={image1}
          alt=""
          className="md:w-[500px] rounded-md object-cover transition delay-150 duration-300 ease-in-out hover:scale-90 border-b-8 border-r-8 "
        />
      </div>
      {/* third section */}
      ...
      <div className="flex flex-col sm:flex-row md:flex-row justify-between px-[2%] sm:px-[5%] lg:px-[8%] mt-32 gap-10 mb-14">
        <div className="relative">
          ...
          <p className="bg-sky-800 text-white px-2  py-2 text-lg rounded-b-md w-11/12">
            Watch our video to learn how you can be a part of the health
            revolution as a Health Coach!
          </p>
        </div>
        <div>
          <h2 className="text-2xl md:text-4xl  font-bold text-sky-700">
