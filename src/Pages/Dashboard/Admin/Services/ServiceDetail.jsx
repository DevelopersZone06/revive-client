    ...
    return (
        <div>
         ...
         <div className="flex justify-center items-center  md:py-3 px-3">
                            <Link to={'https://pdf.ac/9cJh4v'}><button className='rounded-lg px-7 py-2 hover:bg-sky-100 border bg-sky-50 hover:text-sky-700 text-sky-700 font-bold capitalize md:text-sm text-sm  transition-all duration-150 ease-in-out'>Download Pdf</button></Link>
                        </div>
                        <div className="flex justify-center items-center py-3 px-3">
                            <Link to={'https://www.youtube.com/watch?v=AnJ780kE_1Y'}><button className='rounded-lg px-8 py-2 hover:bg-sky-100 border bg-sky-50 hover:text-sky-700 text-sky-700 font-bold capitalize md:text-sm text-sm  transition-all duration-150 ease-in-out'>watch video</button></Link>
                        </div>
                        <div className="flex justify-center items-center py-3 px-3">
