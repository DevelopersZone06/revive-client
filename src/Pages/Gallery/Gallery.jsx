  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center my-14 gap-1">
        <button className="border-secondary px-10 py-2 uppercase text-xl font-semibold  bg-[#448c74] text-white hover:bg-[#448c74] hover:text-white">
          1
        </button>

        <button className="border-secondary px-10 py-2 uppercase text-xl font-semibold  hover:bg-[#448c74] hover:text-white">
          2
        </button>
        <button className="border-secondary px-10 py-2 uppercase text-xl font-semibold  hover:bg-[#448c74] hover:text-white">
          ...
