    ...
    <>
      ...
      <Helmet>
        ...
        <div className="px-[2%] sm:px-[5%] lg:px-[8%]">
          <h2 className="text-2xl md:text-4xl font-bold secondary-color mt-12">
          ...
          <div className="flex justify-between items-center flex-col sm:flex-col md:flex-col lg:flex-row mb-14">
            <div className=" flex-1 my-3">
              <form className={`w-full duration-500 space-y-3`}>
                ...
                <button className="border-secondary px-10 py-2 rounded-md uppercase text-xl font-semibold secondary-color hover:bg-[#448c74] hover:text-white">
                  Submit
                </button>
              </form>
            </div>
