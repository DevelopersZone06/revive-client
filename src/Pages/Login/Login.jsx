      ...
      <div className="login-container container w-full lg:w-4/5 lg:bg-white h-screen lg:h-screen-75 lg:border border-gray-300 rounded-lg flex flex-wrap lg:flex-nowrap flex-col lg:flex-row justify-between group">
        ...
        <div className="w-full lg:w-1/2 h-28 lg:h-full mt-32 lg:mt-0 lg:bg-theme-yellow-dark flex relative order-2 lg:order-1">
          ...
          <div className="text-center hidden lg:flex items-center justify-start h-full w-full select-none">
            ...
            <span className="transform block whitespace-nowrap h-full -rotate-90 text-[55px] 2xl:text-[70px] font-black uppercase text-md secondary-color  opacity-0 transition-all group-hover:opacity-100 ml-10 2xl:ml-12 group-hover:-ml-20 2xl:group-hover:ml-26 lg:group-hover:ml-20 duration-1000 lg:duration-700 ease-in-out">Revive </span>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="form-element">
                  <label className="space-y-2 w-full lg:w-4/5 block mx-auto">
                    <span className="block text-md secondary-color normal font-semibold tracking-wide ">Email</span>
                ...
                <div className="form-element">
                  <label className="space-y-2 w-full lg:w-4/5 block mx-auto">
                    <span className="block text-md text-md normal secondary-color font-semibold  tracking-wide">Password</span>
                    <span className="block">
                ...
                <div className="form-element py-5">
                  <div className="w-full lg:w-4/5  mx-auto flex items-center justify-between">
                    <label className=" text-gray-800 tracking-wide flex items-center space-x-2 select-none">
                      ...
                      <span className="block text-md secondary-color font-semibold tracking-wide">Remember me</span>
                    </label>
                    <a href="#" className=" text-md secondary-color font-semibold tracking-wide inline-block border-b border-gray-300">Forgot Password?</a>
                  </div>
                </div>
                { /*form element */}
