    ...
    return (
        ...
        <div className="w-full lg:w-1/2 h-28 lg:h-full mt-32 lg:mt-0 lg:bg-theme-yellow-dark flex relative order-2 lg:order-1">
          ...
          <div className="text-center hidden lg:flex items-center justify-start h-full w-full select-none">
            ...
            <span className="transform block whitespace-nowrap h-full -rotate-90 text-[55px] 2xl:text-[70px] font-black uppercase text-teal-400 opacity-0 transition-all group-hover:opacity-100 ml-10 2xl:ml-12 group-hover:-ml-20 2xl:group-hover:ml-26 lg:group-hover:ml-20 duration-1000 lg:duration-700 ease-in-out">Revive </span>
          ...
          { /* form element */}
           ...
           <div className="form-element py-5">
             <div className="w-full lg:w-4/5  mx-auto flex items-center justify-between">
               ...
               <a href="#" className=" text-gray-800 tracking-wide inline-block border-b border-gray-300">Forgot Password?</a>
             </div>
           </div>
            { /*form element */}
           ...
           <div className="form-element">
             <span className="w-full lg:w-4/5 block mx-auto ">
              ...
              { /* form element*/}
      <p className='pl-9 '>Don't have an account? <Link className='underline'>Sign Up </Link> </p>
            </div>
          </div>
         { /*form wrapper*/}
        </div>
